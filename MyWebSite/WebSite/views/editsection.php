...
<label>Section Name:</label>
	<input type="text" name="section_name" placeholder="Please a section titel" value="<?php  echo $editrow['section_name'];?>">
	<p>
	<label>Section State</label>
	<select name="sectionstate">
	<?php
	if($editrow['section_state']=="active")
	{
echo'<option value="active">Active</option>
		<option value="disactive">Dis Active</option>';
	}
	else{
		echo'<option value="disactive">Dis Active</option>
	...
	<?php
	if($editrow['section_location']=="Side"){
	...
	<textarea name="sectiondesc" placeholder="please enter a section desc"><?php  echo $editrow['section_desc'];?></textarea>
